    ...
    header_html = widgets.HTML(
        '''<div class="app-header">
            ...
            <div class="header-logo-container">
                ...
                <img src="data:image/png;base64," alt="Barkley Logo" class="header-logo">
            </div>
        </div>'''
    )
